...
class DDR5 : public IDRAM, public Implementation {
  ...
  public:
    inline static const std::map<std::string, Organization> org_presets = {
      ...
      {"DDR5_512Mb_x16",{(8<<10) >> (4),   16, {1, 1, 4, 2, 1<<12, 1<<10}}},
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
      ...
      {"DDR5_4800AN",  {4800,   8,  28,  34,   34,   77,   85,   48,   12,  26,  2,    8,     8,     26+8+4,    8,     16,    26+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,     30,    -1,   -1,   -1,     -1,     -1,    2,   416}},
    };
  ...
  private:
    ...
    void set_timing_vals() {
      ...
      int rate_id = [](int rate) -> int {
        switch (rate) {
          case 3200:
          case 4800:  return 0; // "support" 4800
          default:    return -1;
        }
      }(m_timing_vals("rate"));
      ...
      m_BRC = 2; //param_group("RFM").param<int>("BRC").default_val(2);
