...
module purge 
module load perf/5.11.10
module load papi/6.0.0
module load openmpi/ubuntu/4.1.1_gcc10.3.0





./create_runner_config.sh config/HiFive.toml 
...
export TIME_AFTER_STREAM_TERMINATION=${TIME_AFTER_STREAM_TERMINATION}
