...
def main():
    ...
    visualization.final_curves(config, os.path.join(output_dir, 'bandwidth-latency.pdf'), dfs_rw, lat_column='latency_mean', bw_column='bandwidth_mean', lat_unit='ns', original_data_points=dfs_rw_original)
